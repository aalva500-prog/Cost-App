...
public class GestionarMaterialExtranjeroVisual extends JFrame {
	/**
	 * 
	 */
	...
	private JLabel jLabel372 = null;
	private JLabel jLabel373 = null;
	
	
	public GestionarMaterialExtranjeroVisual(Material mp) {
		super();
		this.mp=mp;
		initialize();		
	...
	private void initialize() {
		...
		TransportaciónAerea ta = ServicioTransportacionAerea.getTransportacionMaterial(mp.getId_material());
		...
		TipoTransportacionjLabel.setText("*Tipo de Transportación:  " + ta.getTipotransportacion());
		...
		Desaduanizacion des=ServicioDesaduanizacion.getDesaduanizacionMaterial(mp.getId_material());
		if(des.getNombreproveedor()!=null|| des.getNumerofactura()!=null|| des.getFechafactura()!=null ||des.getFechatasacambio()!=null){
			...
			jLabel4.setText("*Tipo de Desaduanización:  " + des.getTipodesaduanizacion());
		...
		TransportacionTerrestre terrestre = ServicioTerrestre.getTransportacionTerrestreMaterial(mp.getId_material());
		...
		Aduana adu=ServicioAduana.getAduanaMaterial(mp.getId_material());
	...
	private JButton getCostoUnitarioTotaljButton() {
		if (CostoUnitarioTotaljButton == null) {
			...
			CostoUnitarioTotaljButton.setBounds(new Rectangle(301, 316, 183, 26));
			CostoUnitarioTotaljButton.addActionListener(new java.awt.event.ActionListener() {
						public void actionPerformed(java.awt.event.ActionEvent e) {
							DecimalFormatSymbols simbolo=new DecimalFormatSymbols();
						    simbolo.setDecimalSeparator('.');
							DecimalFormat dosDigitos = new DecimalFormat( "####.#####",simbolo);
							double adquisicion=Double.valueOf(PrecioAdquisicionUSDjTextField.getText());
							double gastos=Double.valueOf(PrecioConvertidoDOPaUSDjTextField.getText());
							double transportacionAerea=Double.valueOf(CostoTransportacionAereajTextField.getText());
							double desaduanizacion=Double.valueOf(CsotoUnitarioDesadunaizacionjTextField.getText());
							double terrestre=Double.valueOf(CostoUnitariodelTarnasportacionTerrestrejTextField.getText());
							double zonafranca= Double.valueOf(CostoUnitarioAdunajTextField.getText());
							double molde= Double.valueOf(jTextField.getText());
							double suma=0;
							if(gastos!=0 && molde==0){
							...
							if(gastos==0 && molde!=0){
								suma=molde+transportacionAerea+desaduanizacion+terrestre+zonafranca;
								CostoUnitarioTotaljTextField.setText(String.valueOf(dosDigitos.format(suma)));
							}
							
							if(gastos!=0 && molde!=0){
								suma=(molde+gastos+transportacionAerea+desaduanizacion+terrestre+zonafranca) - adquisicion;		
								CostoUnitarioTotaljTextField.setText(String.valueOf(dosDigitos.format(suma)));
							}
	...
	private JTextField getCostoUnitarioTotaljTextField() {
		if (CostoUnitarioTotaljTextField == null) {
			...
			CostoUnitarioTotaljTextField.setBounds(new Rectangle(484, 316, 183, 26));
			DecimalFormatSymbols simbolo=new DecimalFormatSymbols();
		    simbolo.setDecimalSeparator('.');
			DecimalFormat dosDigitos = new DecimalFormat( "####.#####",simbolo);
	...
	private JPanel getJPanel() {
		if (jPanel == null) {
			...
			jLabel2 = new JLabel();
			jLabel2.setText("No. Factura:  " + mp.getFactura());
			jLabel2.setBounds(new Rectangle(14, 67, 291, 29));
			jLabel1 = new JLabel();
			jLabel1.setText("Proveedor:  " + mp.getProveedor());
	...
	private JPanel getJPanel4() {
		if (jPanel4 == null) {
			...
			gridBagConstraints10.insets = new Insets(4, 6, 1, 10);
			gridBagConstraints10.gridy = 0;
			gridBagConstraints10.ipadx = 840;
			gridBagConstraints10.ipady = 349;
			gridBagConstraints10.gridx = 0;
			GridBagConstraints gridBagConstraints9 = new GridBagConstraints();
			gridBagConstraints9.insets = new Insets(14, 11, 117, 83);
			gridBagConstraints9.gridy = 0;
			gridBagConstraints9.ipadx = 319;
			gridBagConstraints9.ipady = 223;
			gridBagConstraints9.gridx = 1;
			GridBagConstraints gridBagConstraints8 = new GridBagConstraints();
			gridBagConstraints8.insets = new Insets(1, 53, 3, 179);
			gridBagConstraints8.gridy = 1;
			gridBagConstraints8.ipadx = 624;
			gridBagConstraints8.ipady = 84;
			gridBagConstraints8.gridx = 0;
			jLabel36 = new JLabel();
			if(mp.getMoneda().equals("USD")){			
			jLabel36.setText("Precio de Adquisición en USD con Costos del Molde incluido:");
			jLabel36.setBounds(new Rectangle(141, 92, 343, 26));
			}else{
				jLabel36.setText("Precio de Adquisición Convertido de EUR a USD con Costos del Molde incluido:");
				jLabel36.setBounds(new Rectangle(40, 97, 444, 26));
			}
			jLabel35 = new JLabel();
			jLabel35.setText("Costo Unitario de los Gastos en Aduana de la Zona Franca:");
			jLabel35.setBounds(new Rectangle(152, 269, 332, 26));
			jLabel34 = new JLabel();
			jLabel34.setText("Costo Unitario de la Transportación Terrestre:");
			jLabel34.setBounds(new Rectangle(222, 227, 262, 26));
			jLabel33 = new JLabel();
			jLabel33.setText("Costo Unitario de la Desaduanización:");
			jLabel33.setBounds(new Rectangle(268, 178, 216, 26));
			jLabel32 = new JLabel();
			jLabel32.setText("Costo Unitario de la Transportación Aérea o Marítima:");
			jLabel32.setBounds(new Rectangle(178, 136, 306, 26));
			jLabel31 = new JLabel();
			if(mp.getMoneda().equals("USD")){			
			jLabel31.setText("Precio de Adquisición en USD con Gastos de Flete y otros incluido:");
			jLabel31.setBounds(new Rectangle(111, 50, 373, 26));
		    }else{
		    	jLabel31.setText("Precio de Adquisición Convertido de EUR a USD con Gastos de Flete y otros incluido:");
		    	jLabel31.setBounds(new Rectangle(6, 55, 478, 26));
		    }
			jLabel30 = new JLabel();					
			if(mp.getMoneda().equals("USD")){
			jLabel30.setText("Precio de Adquisición en USD:");	
			jLabel30.setBounds(new Rectangle(311, 10, 173, 26));
			}else{
				jLabel30.setText("Precio de Adquisición Convertido de EUR a USD:");	
				jLabel30.setBounds(new Rectangle(210, 10, 274, 26));
			}
			jPanel4 = new JPanel();
	...
	private JPanel getJPanel5() {
		if (jPanel5 == null) {
			jLabel37 = new JLabel();
			jLabel37.setBounds(new Rectangle(14, 100, 290, 31));
			jLabel37.setText("Tipo de Material:  " + mp.getTipomaterial());
			jPanel5 = new JPanel();
			jPanel5.setLayout(null);
			jPanel5.setBorder(BorderFactory.createTitledBorder(null, "Datos del Material", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, new Font("Dialog", Font.BOLD, 12), new Color(51, 51, 51)));
	...
	private JTextField getNombreProveedorjTextField() {
		if (NombreProveedorjTextField == null) {
			...
			NombreProveedorjTextField.setBounds(new Rectangle(245, 44, 211, 25));
	...
	private JTextField getNumeroFacturajTextField() {
		if (NumeroFacturajTextField == null) {
			...
			NumeroFacturajTextField.setBounds(new Rectangle(464, 46, 137, 25));
		}
	...
	private JSpinner getDatejSpinner() {
		if (DatejSpinner == null) {
			...
			DatejSpinner.setBounds(new Rectangle(611, 48, 142, 25));
		}
		return DatejSpinner;
	}
	...
	private JTextField getCantidadTransportadajTextField() {
		if (CantidadTransportadajTextField == null) {
			...
			CantidadTransportadajTextField.setBounds(new Rectangle(764, 48, 149, 25));
	...
	private JComboBox getMonedajComboBox1() {
		if (MonedajComboBox1 == null) {
			...
			MonedajComboBox1.setBounds(new Rectangle(924, 48, 167, 25));
	...
	private JTextField getImporteFacturajTextField() {
		if (ImporteFacturajTextField == null) {
			...
			ImporteFacturajTextField.setBounds(new Rectangle(1104, 48, 139, 25));
			...
			jButton.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					ImporteConvertidojTextField.setText(String.valueOf(dosDigitos.format(conversion)));				
						...
						JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "El Tipo de Moneda debe ser EUR", "Información", JOptionPane.ERROR_MESSAGE);
					}
		...
		if (InsertarjButton1 == null) {
			...
			InsertarjButton1.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					try {
						ServicioTransportacionAerea.insertarTransportacionAereaMaterial(NombreProveedorjTextField.getText(), NumeroFacturajTextField.getText(), sqlDate, Float.valueOf(CantidadTransportadajTextField.getText()), ((TipoMoneda)getMonedajComboBox1().getSelectedItem()).getId_tipomoneda(), Float.valueOf(ImporteFacturajTextField.getText()), sqlDate1, Float.valueOf(TasaConversionjTextField.getText()), Float.valueOf(ImporteConvertidojTextField.getText()), Float.valueOf(CostojTextField.getText()), mp.getId_material(),  ((Tipo)getJComboBox().getSelectedItem()).getId_tipo());
						JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "Transportación Registrada con Éxito", "Información", JOptionPane.INFORMATION_MESSAGE);
						...
						TipoTransportacionjLabel.setText("*Tipo de Transportación:  " + ((Tipo)getJComboBox().getSelectedItem()).getTipo());
						jButton18.setEnabled(true);
						InsertarjButton1.setEnabled(false);
						...
						JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "Ya existe el Registro", "Información", JOptionPane.ERROR_MESSAGE);
						// TODO Auto-generated catch block
						e1.printStackTrace();
					} catch (ClassNotFoundException e1) {
						// TODO Auto-generated catch block
						...
						if(((TipoMoneda)getMonedajComboBox1().getSelectedItem()).getDescripcion().equals("USD") && ImporteConvertidojTextField.getText().length()==0){
							...
							//java.sql.Date sqlDate1 = new java.sql.Date(getDatespinnerDateModel1().getDate().getTime());	
							try {
								ServicioTransportacionAerea.insertarTransportacionAereaMaterial(NombreProveedorjTextField.getText(), NumeroFacturajTextField.getText(), sqlDate, Float.valueOf(CantidadTransportadajTextField.getText()), ((TipoMoneda)getMonedajComboBox1().getSelectedItem()).getId_tipomoneda(), Float.valueOf(ImporteFacturajTextField.getText()), null, 0, 0, Float.valueOf(CostojTextField.getText()), mp.getId_material(),  ((Tipo)getJComboBox().getSelectedItem()).getId_tipo());
								JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "Transportación Registrada con Éxito", "Información", JOptionPane.INFORMATION_MESSAGE);
								CostoTransportacionAereajTextField.setText(CostojTextField.getText());
								CantidadTransportadaDesjTextField1.setText(CantidadTransportadajTextField.getText());
								CAntidadTransportadajTextField.setText(CantidadTransportadajTextField.getText());
						...
						JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "Debe seleccionar el Tipo de Moneda y El Tipo de Transportación", "Información", JOptionPane.ERROR_MESSAGE);
					}
					System.out.println("actionPerformed()"); // TODO Auto-generated Event stub actionPerformed()
				}
			});
	...
	private JButton getRegresarjButton1() {
		if (RegresarjButton1 == null) {
			...
			RegresarjButton1.setText("Listado de Materiales Importados");
	...
	private JPanel getJPanel7() {
		if (jPanel7 == null) {
			...
			jLabel371.setBounds(new Rectangle(14, 103, 291, 29));
			jLabel371.setText("Tipo de Material:  " + mp.getTipomaterial());
			jLabel3 = new JLabel();
			jLabel3.setText("Proveedor:  " + mp.getProveedor());
			jLabel3.setBounds(new Rectangle(14, 33, 291, 29));
			jLabel = new JLabel(); 
			jLabel.setText("No. Factura:  " + mp.getFactura());
			jLabel.setBounds(new Rectangle(14, 67, 291, 29));
			jPanel7 = new JPanel();
			jPanel7.setLayout(null);
			jPanel7.setBorder(BorderFactory.createTitledBorder(null, "Datos del Material", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, new Font("Dialog", Font.BOLD, 12), new Color(51, 51, 51)));
			jPanel7.add(jLabel, null);
			jPanel7.add(jLabel3, null);
			jPanel7.add(getJScrollPane2(), null);
			jPanel7.add(jLabel371, null);
		}
		return jPanel7;
	}
	...
	private JPanel getJPanel8() {
		if (jPanel8 == null) {
			...
			CantijLabel7.setBounds(new Rectangle(1084, 25, 140, 23));
			ImportejLabel7 = new JLabel();
			ImportejLabel7.setText("*Importe de la Factura:");
			ImportejLabel7.setBounds(new Rectangle(944, 25, 131, 23));
			jLabel6 = new JLabel();
			jLabel6.setText("*Tipo de Moneda:");
			jLabel6.setBounds(new Rectangle(780, 23, 155, 23));
			FechaFacturaDesjLabel6 = new JLabel();
			FechaFacturaDesjLabel6.setText("Fecha Factura:");
			FechaFacturaDesjLabel6.setBounds(new Rectangle(614, 25, 155, 23));
			jLabel5 = new JLabel();
			jLabel5.setText("*Número de la Factura:");
			jLabel5.setBounds(new Rectangle(459, 24, 147, 23));
			NombreProveedorjLabel5 = new JLabel();
			NombreProveedorjLabel5.setText("*Nombre del Proveedor:");
			NombreProveedorjLabel5.setBounds(new Rectangle(273, 24, 177, 23));
			jLabel4 = new JLabel();
			jLabel4.setText("*Tipo de Desaduanización:");
			jLabel4.setBounds(new Rectangle(15, 25, 244, 23));
			jPanel8 = new JPanel();
	...
	private JTextField getNombreProveedorDesjTextField1() {
		if (NombreProveedorDesjTextField1 == null) {
			...
			NombreProveedorDesjTextField1.setBounds(new Rectangle(273, 47, 177, 25));
		}
	...
	private JTextField getNUmeroFacturaDesjTextField1() {
		if (NUmeroFacturaDesjTextField1 == null) {
			...
			NUmeroFacturaDesjTextField1.setBounds(new Rectangle(459, 47, 147, 25));
		}
	...
	private JSpinner getDatejSpinner2() {
		if (DatejSpinner2 == null) {
			...
			DatejSpinner2.setBounds(new Rectangle(613, 48, 155, 23));
		}
	...
	private JComboBox getMonedaDesjComboBox1() {
		if (MonedaDesjComboBox1 == null) {
			...
			MonedaDesjComboBox1.setBounds(new Rectangle(780, 46, 155, 23));
	...
	private JTextField getImportejTextField1() {
		if (ImportejTextField1 == null) {
			...
			ImportejTextField1.setBounds(new Rectangle(944, 48, 131, 25));
	...
	private JTextField getCantidadTransportadaDesjTextField1() {
		if (CantidadTransportadaDesjTextField1 == null) {
			...
			CantidadTransportadaDesjTextField1.setBounds(new Rectangle(1085, 48, 137, 25));
		}
		...
		if (jButton1 == null) {
			...
			jButton1.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
				    ...
				    simbolo.setDecimalSeparator('.');
					DecimalFormat dosDigitos = new DecimalFormat( "####.#####",simbolo);
					if(getMonedaDesjComboBox1().getSelectedIndex()==1){
				...
				ImprteConvertidoDesjTextField1.setText(String.valueOf(dosDigitos.format(convert)));						
							...
							JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "El Tipo de Moneda debe ser DOP", "Información", JOptionPane.ERROR_MESSAGE);
						}
					System.out.println("actionPerformed()"); // TODO Auto-generated Event stub actionPerformed()
				}
			});
		...
		if (RegistrarDesaduanizacionjButton3 == null) {
			...
			RegistrarDesaduanizacionjButton3.addActionListener(new java.awt.event.ActionListener() {
						public void actionPerformed(java.awt.event.ActionEvent e) {
							...
							try {
								ServicioDesaduanizacion.insertarDesaduanizacionMaterial(NombreProveedorDesjTextField1.getText(), NUmeroFacturaDesjTextField1.getText(), sqlDate, ((TipoMoneda)getMonedaDesjComboBox1().getSelectedItem()).getId_tipomoneda(),Float.valueOf(ImportejTextField1.getText()), sqlDate1, Float.valueOf(TasaCambioDesjTextField1.getText()), Float.valueOf(ImprteConvertidoDesjTextField1.getText()), Float.valueOf(CostoDesjTextField1.getText()), mp.getId_material(), ((Tipo)getTipoDesjComboBox1().getSelectedItem()).getId_tipo(), Float.valueOf(CantidadTransportadaDesjTextField1.getText()));
								JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "Desaduanización Registrada con Éxito", "Información", JOptionPane.INFORMATION_MESSAGE);
								CsotoUnitarioDesadunaizacionjTextField.setText(CostoDesjTextField1.getText());
								jLabel4.setText("*Tipo de Desaduanización:  " + ((TipoMoneda)getMonedaDesjComboBox1().getSelectedItem()).getDescripcion());
								jButton19.setEnabled(true);
							RegistrarDesaduanizacionjButton3.setEnabled(false);
							} catch (NumberFormatException e1) {
								// TODO Auto-generated catch block
								...
								JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "Ya existe el Registro", "Información", JOptionPane.INFORMATION_MESSAGE);
								// TODO Auto-generated catch block
								e1.printStackTrace();
							} catch (ClassNotFoundException e1) {
								// TODO Auto-generated catch block
								...
								if(((TipoMoneda)getMonedaDesjComboBox1().getSelectedItem()).getDescripcion().equals("USD") && ImprteConvertidoDesjTextField1.getText().length()==0){
									java.sql.Date sqlDate = new java.sql.Date(getDatespinnerDateModel2().getDate().getTime());
									try {
										ServicioDesaduanizacion.insertarDesaduanizacionMaterial(NombreProveedorDesjTextField1.getText(), NUmeroFacturaDesjTextField1.getText(), sqlDate, ((TipoMoneda)getMonedaDesjComboBox1().getSelectedItem()).getId_tipomoneda(),Float.valueOf(ImportejTextField1.getText()), null, 0, 0, Float.valueOf(CostoDesjTextField1.getText()), mp.getId_material(), ((Tipo)getTipoDesjComboBox1().getSelectedItem()).getId_tipo(), Float.valueOf(CantidadTransportadaDesjTextField1.getText()));
										JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "Desaduanización Registrada con Éxito", "Información", JOptionPane.INFORMATION_MESSAGE);
										CsotoUnitarioDesadunaizacionjTextField.setText(CostoDesjTextField1.getText());
										jLabel4.setText("*Tipo de Desaduanización:  " + ((TipoMoneda)getMonedaDesjComboBox1().getSelectedItem()).getDescripcion());
										jButton19.setEnabled(true);
								...
								JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "Debe seleccionar el Tipo de Moneda y el Tipo de Desaduanización", "Información", JOptionPane.ERROR_MESSAGE);
							}
							System.out.println("actionPerformed()"); // TODO Auto-generated Event stub actionPerformed()
						}
					});
	...
	private JButton getJButton3() {
		if (jButton3 == null) {
			...
			jButton3.setText("Listado de Materiales Importados");
	...
	private JComboBox getTipoDesjComboBox1() {
		if (TipoDesjComboBox1 == null) {
			...
			TipoDesjComboBox1.setBounds(new Rectangle(15, 48, 177, 25));
		}
	...
	private JPanel getJPanel9() {
		if (jPanel9 == null) {
			jLabel372 = new JLabel();
			jLabel372.setBounds(new Rectangle(14, 101, 291, 29));
			jLabel372.setText("Tipo de Material:  " + mp.getTipomaterial());
			jLabel21 = new JLabel();
			jLabel21.setBounds(new Rectangle(14, 67, 291, 29));
			jLabel21.setText("No. Factura:  " + mp.getFactura());
			jLabel20 = new JLabel();
			jLabel20.setBounds(new Rectangle(14, 33, 291, 29));
			jLabel20.setText("Proveedor:  " + mp.getProveedor());
			jPanel9 = new JPanel();
			jPanel9.setLayout(null);
			jPanel9.setBorder(BorderFactory.createTitledBorder(null, "Datos del Material", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, new Font("Dialog", Font.BOLD, 12), new Color(51, 51, 51)));
			jPanel9.add(jLabel20, null);
			jPanel9.add(jLabel21, null);
			jPanel9.add(getJScrollPane1(), null);
			jPanel9.add(jLabel372, null);
		}
		return jPanel9;
	}
	...
	private JPanel getJPanel10() {
		if (jPanel10 == null) {
			...
			jLabel16 = new JLabel();
			jLabel16.setBounds(new Rectangle(907, 24, 145, 23));
			jLabel16.setText("Cantidad Transportada:");
			jLabel15 = new JLabel();
			jLabel15.setBounds(new Rectangle(746, 24, 145, 23));
			jLabel15.setText("*Importe de la Factura:");
			jLabel14 = new JLabel();
			jLabel14.setBounds(new Rectangle(557, 24, 174, 23));
	...
	private JTextField getImporteTerrestrejTextField() {
		if (ImporteTerrestrejTextField == null) {
			...
			ImporteTerrestrejTextField.setBounds(new Rectangle(746, 46, 145, 23));
	...
	private JTextField getCAntidadTransportadajTextField() {
		if (CAntidadTransportadajTextField == null) {
			CAntidadTransportadajTextField = new JTextField();
			CAntidadTransportadajTextField.setBounds(new Rectangle(907, 46, 145, 23));
			}
		return CAntidadTransportadajTextField;
	}
			...
			jButton4.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
			        ...
			        ImportejTextField.setText(String.valueOf(dosDigitos.format(result)));
							...
							JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "El Campo Tasa de Conversión no puede estar vacío", "Información", JOptionPane.ERROR_MESSAGE);
							}
						}else{
							JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "El Tipo de Moneda debe ser DOP", "Información", JOptionPane.ERROR_MESSAGE);
						}
	...
	private JButton getJButton6() {
		if (jButton6 == null) {
			...
			jButton6.addActionListener(new java.awt.event.ActionListener() {
				...
				try {
						ServicioTerrestre.insertarTransportacionTerrestreMaterial(NombreProveedorTerrestrejTextField.getText(), NumeroFacturaTerrestrejTextField.getText(), sqlDate, ((TipoMoneda)getMonedaTerrestrejComboBox1().getSelectedItem()).getId_tipomoneda(), Float.valueOf(ImporteTerrestrejTextField.getText()), sqlDate1, Float.valueOf(TasaCAmbiojTextField.getText()), Float.valueOf(ImportejTextField.getText()), Float.valueOf(CostoTerrestrejTextField.getText()), mp.getId_material(), Float.valueOf(CantidadTransportadajTextField.getText()));
						JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "Transportación Terrestre Registrada con Éxito", "Información", JOptionPane.INFORMATION_MESSAGE);
				...
				jButton6.setEnabled(false);
						...
						if(((TipoMoneda)getMonedaTerrestrejComboBox1().getSelectedItem()).getDescripcion().equals("USD") && ImportejTextField.getText().length()==0){
							...
							java.sql.Date sqlDate = new java.sql.Date(getDatespinnerDateModel2().getDate().getTime());
							try {
								ServicioTerrestre.insertarTransportacionTerrestreMaterial(NombreProveedorTerrestrejTextField.getText(), NumeroFacturaTerrestrejTextField.getText(), sqlDate, ((TipoMoneda)getMonedaTerrestrejComboBox1().getSelectedItem()).getId_tipomoneda(), Float.valueOf(ImporteTerrestrejTextField.getText()), null, 0, 0, Float.valueOf(CostoTerrestrejTextField.getText()), mp.getId_material(), Float.valueOf(CantidadTransportadajTextField.getText()));
								JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "Transportación Terrestre Registrada con Éxito", "Información", JOptionPane.INFORMATION_MESSAGE);
								CostoUnitariodelTarnasportacionTerrestrejTextField.setText(CostoTerrestrejTextField.getText());
								jButton20.setEnabled(true);
								jButton6.setEnabled(false);
						...
						JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "Debe seleccionar el Tipo de Moneda", "Información", JOptionPane.ERROR_MESSAGE);
					}
					System.out.println("actionPerformed()"); // TODO Auto-generated Event stub actionPerformed()
				}
			});
	...
	private JButton getJButton7() {
		if (jButton7 == null) {
			...
			jButton7.setText("Listado de Materiales Importados");
	...
	private JPanel getJPanel11() {
		if (jPanel11 == null) {
			jLabel373 = new JLabel();
			jLabel373.setBounds(new Rectangle(14, 101, 291, 29));
			jLabel373.setText("Tipo de Material:  " + mp.getTipomaterial());
			jLabel23 = new JLabel();
			jLabel23.setBounds(new Rectangle(14, 67, 291, 29));
			jLabel23.setText("No. Factura:  " + mp.getFactura());
			jLabel22 = new JLabel();
			jLabel22.setBounds(new Rectangle(14, 33, 291, 29));
			jLabel22.setText("Proveedor:  " + mp.getProveedor());
			jPanel11 = new JPanel();
			jPanel11.setLayout(null);
			jPanel11.setBorder(BorderFactory.createTitledBorder(null, "Datos del Material", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, new Font("Dialog", Font.BOLD, 12), new Color(51, 51, 51)));
			jPanel11.add(jLabel22, null);
			jPanel11.add(jLabel23, null);
			jPanel11.add(getJScrollPane(), null);
			jPanel11.add(jLabel373, null);
		}
		return jPanel11;
	}
			...
			RegitsrajButton10.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if(ImporteDOPjTextField.getText().length()!=0 && TasaCAmbioADuanajTextField.getText().length()!=0 && ImporteAduanajTextField.getText().length()!=0 && CostoAduanajTextField.getText().length()!=0){
						...
						try {
							ServicioAduana.insertarAduanaMaterial(Float.valueOf(ImporteDOPjTextField.getText()), sqlDate, Float.valueOf(TasaCAmbioADuanajTextField.getText()), Float.valueOf(ImporteAduanajTextField.getText()), Float.valueOf(CantidadTransportadajTextField.getText()), Float.valueOf(CostoAduanajTextField.getText()), mp.getId_material());
							JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "Pago en Aduana de la Zona Franca Registrado con Éxito", "Información", JOptionPane.INFORMATION_MESSAGE);
						...
						JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "Los Datos señalados con * son obligatorios", "Error", JOptionPane.ERROR_MESSAGE);
					}
					System.out.println("actionPerformed()"); // TODO Auto-generated Event stub actionPerformed()
				}
			});
	...
	private JButton getJButton10() {
		if (jButton10 == null) {
			...
			jButton10.setText("Listado de Materiales Importados");
	...
	private JTextField getPrecioAdquisicionUSDjTextField() {
		if (PrecioAdquisicionUSDjTextField == null) {
			...
			PrecioAdquisicionUSDjTextField.setBounds(new Rectangle(484, 10, 183, 26));
			DecimalFormatSymbols simbolo=new DecimalFormatSymbols();
		    simbolo.setDecimalSeparator('.');
			DecimalFormat dosDigitos = new DecimalFormat( "####.#####",simbolo);
			
			if(mp.getPrecioadqusicionconvertidoEURaUSD()!=0){
				PrecioAdquisicionUSDjTextField.setText(String.valueOf(dosDigitos.format(mp.getPrecioadqusicionconvertidoEURaUSD())));
			}else{
			PrecioAdquisicionUSDjTextField.setText(String.valueOf(dosDigitos.format(mp.getPrecioadquisicion())));
			}
		}
	...
	private JTextField getPrecioConvertidoDOPaUSDjTextField() {
		if (PrecioConvertidoDOPaUSDjTextField == null) {
			...
			PrecioConvertidoDOPaUSDjTextField.setBounds(new Rectangle(484, 50, 183, 26));
			DecimalFormatSymbols simbolo=new DecimalFormatSymbols();
		    simbolo.setDecimalSeparator('.');
			DecimalFormat dosDigitos = new DecimalFormat( "####.#####",simbolo);
			if(mp.getPrecioAdqusicionconvertidoEURaUSDconGastos()!=0){
				PrecioConvertidoDOPaUSDjTextField.setText(String.valueOf(dosDigitos.format(mp.getPrecioAdqusicionconvertidoEURaUSDconGastos())));
			}else{
				PrecioConvertidoDOPaUSDjTextField.setText(String.valueOf(dosDigitos.format(mp.getPrecioAdquisicionUSDconGAStos())));
			}
		}
	...
	private JTextField getCostoTransportacionAereajTextField() {
		if (CostoTransportacionAereajTextField == null) {
			...
			CostoTransportacionAereajTextField.setBounds(new Rectangle(484, 136, 183, 26));
			TransportaciónAerea ta = ServicioTransportacionAerea.getTransportacionMaterial(mp.getId_material());
	...
	private JTextField getCsotoUnitarioDesadunaizacionjTextField() {
		if (CsotoUnitarioDesadunaizacionjTextField == null) {
			...
			CsotoUnitarioDesadunaizacionjTextField.setBounds(new Rectangle(484, 178, 183, 26));
			Desaduanizacion des=ServicioDesaduanizacion.getDesaduanizacionMaterial(mp.getId_material());
	...
	private JTextField getCostoUnitariodelTarnasportacionTerrestrejTextField() {
		if (CostoUnitariodelTarnasportacionTerrestrejTextField == null) {
			...
			CostoUnitariodelTarnasportacionTerrestrejTextField.setBounds(new Rectangle(484, 227, 183, 26));
			TransportacionTerrestre terrestre = ServicioTerrestre.getTransportacionTerrestreMaterial(mp.getId_material());
	...
	private JTextField getCostoUnitarioAdunajTextField() {
		if (CostoUnitarioAdunajTextField == null) {
			...
			CostoUnitarioAdunajTextField.setBounds(new Rectangle(484, 269, 183, 26));
			Aduana adu=ServicioAduana.getAduanaMaterial(mp.getId_material());
	...
	private JButton getJButton15() {
		if (jButton15 == null) {
			...
			jButton15.setBounds(new Rectangle(16, 10, 286, 35));
			...
			jButton15.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if(LogisticajTextField.getText().length()!=0){
						try {
							ServicioMaterial.InsertarCostoMaterialImportado(mp.getId_material(), Float.valueOf(CostoUnitarioTotaljTextField.getText()), Float.valueOf(LogisticajTextField.getText()));
							JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "Costo Registrado con Éxito", "Información", JOptionPane.INFORMATION_MESSAGE);
						} catch (NumberFormatException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						} catch (SQLException e1) {
						...
						try {
							ServicioMaterial.InsertarCostoMaterialImportadosinLogistica(mp.getId_material(), Float.valueOf(CostoUnitarioTotaljTextField.getText()));
							JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "Costo Registrado con Éxito", "Información", JOptionPane.INFORMATION_MESSAGE);
						} catch (NumberFormatException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
	...
	private JButton getJButton16() {
		if (jButton16 == null) {
			...
			jButton16.setText("Listado de Materiales Importados");
			jButton16.setBounds(new Rectangle(16, 118, 286, 35));
	...
	private JButton getJButton17() {
		if (jButton17 == null) {
			...
			jButton17.setBounds(new Rectangle(16, 173, 286, 35));
			...
			jButton18.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if(getJComboBox().getSelectedIndex()!=0 && getMonedajComboBox1().getSelectedIndex()!=0){
						...
						if(((TipoMoneda)getMonedajComboBox1().getSelectedItem()).getDescripcion().equals("EUR") && ImporteConvertidojTextField.getText().length()!=0){
						try {
							ServicioTransportacionAerea.ModificarTransporteAereoMaterial(mp.getId_material(), Float.valueOf(ImporteFacturajTextField.getText()), sqlDate1, Float.valueOf(TasaConversionjTextField.getText()), Float.valueOf(ImporteConvertidojTextField.getText()), Float.valueOf(CantidadTransportadajTextField.getText()), Float.valueOf(CostojTextField.getText()), NombreProveedorjTextField.getText(), NumeroFacturajTextField.getText(), sqlDate, ((TipoMoneda)getMonedajComboBox1().getSelectedItem()).getId_tipomoneda(), ((Tipo)getJComboBox().getSelectedItem()).getId_tipo());
							JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "Transportación Modificada con Éxito", "Información", JOptionPane.INFORMATION_MESSAGE);
						    CostoTransportacionAereajTextField.setText(CostojTextField.getText());
						} catch (NumberFormatException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						...
						if(((TipoMoneda)getMonedajComboBox1().getSelectedItem()).getDescripcion().equals("USD")){
							try {
								ServicioTransportacionAerea.ModificarTransporteAereoMaterial(mp.getId_material(), Float.valueOf(ImporteFacturajTextField.getText()), null,0, 0, Float.valueOf(CantidadTransportadajTextField.getText()), Float.valueOf(CostojTextField.getText()), NombreProveedorjTextField.getText(), NumeroFacturajTextField.getText(), sqlDate, ((TipoMoneda)getMonedajComboBox1().getSelectedItem()).getId_tipomoneda(), ((Tipo)getJComboBox().getSelectedItem()).getId_tipo());
								JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "Transportación Modificada con Éxito", "Información", JOptionPane.INFORMATION_MESSAGE);
								TasaConversionjTextField.setText("");
								ImporteConvertidojTextField.setText("");
								 CostoTransportacionAereajTextField.setText(CostojTextField.getText());
							...
							JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "Debe Elegir el Tipo de Moneda y el Tipo de Transportación", "Información", JOptionPane.ERROR_MESSAGE);
						}
					System.out.println("actionPerformed()"); // TODO Auto-generated Event stub actionPerformed()
				}
			});
		...
		if (jButton19 == null) {
			...
			jButton19.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					if(((TipoMoneda)getMonedaDesjComboBox1().getSelectedItem()).getDescripcion().equals("DOP") && ImprteConvertidoDesjTextField1.getText().length()!=0){
					try {
						ServicioDesaduanizacion.ModificarDesadunaizacionMaterial(mp.getId_material(), Float.valueOf(ImportejTextField1.getText()), sqlDate1, Float.valueOf(TasaCambioDesjTextField1.getText()), Float.valueOf(ImprteConvertidoDesjTextField1.getText()), Float.valueOf(CantidadTransportadajTextField.getText()), Float.valueOf(CostoDesjTextField1.getText()), NombreProveedorDesjTextField1.getText(), NUmeroFacturaDesjTextField1.getText(), sqlDate, ((TipoMoneda)getMonedaDesjComboBox1().getSelectedItem()).getId_tipomoneda(), ((Tipo)getTipoDesjComboBox1().getSelectedItem()).getId_tipo());
						JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "Desaduanización Modificada con Éxito", "Información", JOptionPane.INFORMATION_MESSAGE);
						CsotoUnitarioDesadunaizacionjTextField.setText(CostoDesjTextField1.getText());
					} catch (NumberFormatException e1) {
						// TODO Auto-generated catch block
						e1.printStackTrace();
					...
					if(((TipoMoneda)getMonedaDesjComboBox1().getSelectedItem()).getDescripcion().equals("USD")){
						try {
							ServicioDesaduanizacion.ModificarDesadunaizacionMaterial(mp.getId_material(), Float.valueOf(ImportejTextField1.getText()), null, 0, 0, Float.valueOf(CantidadTransportadajTextField.getText()), Float.valueOf(CostoDesjTextField1.getText()), NombreProveedorDesjTextField1.getText(), NUmeroFacturaDesjTextField1.getText(), sqlDate, ((TipoMoneda)getMonedaDesjComboBox1().getSelectedItem()).getId_tipomoneda(), ((Tipo)getTipoDesjComboBox1().getSelectedItem()).getId_tipo());
							JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "Desaduanización Modificada con Éxito", "Información", JOptionPane.INFORMATION_MESSAGE);
							CsotoUnitarioDesadunaizacionjTextField.setText(CostoDesjTextField1.getText());
							TasaCambioDesjTextField1.setText("");
							ImprteConvertidoDesjTextField1.setText("");
						...
						JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "Debe Elegir el Tipo de Moneda y el Tipo de Desaduanización", "Información", JOptionPane.ERROR_MESSAGE);
					}
					System.out.println("actionPerformed()"); // TODO Auto-generated Event stub actionPerformed()
				}
			});
			...
			jButton20.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					if(getMonedaTerrestrejComboBox1().getSelectedIndex()!=0){
						if(((TipoMoneda)getMonedaTerrestrejComboBox1().getSelectedItem()).getDescripcion().equals("DOP") && ImportejTextField.getText().length()!=0){
					try {
						ServicioTerrestre.ModificarTransporteTerrestreMaterial(mp.getId_material(), Float.valueOf(ImporteTerrestrejTextField.getText()), sqlDate1, Float.valueOf(TasaCAmbiojTextField.getText()), Float.valueOf(ImportejTextField.getText()), Float.valueOf(CantidadTransportadajTextField.getText()), Float.valueOf(CostoTerrestrejTextField.getText()), NombreProveedorTerrestrejTextField.getText(), NumeroFacturaTerrestrejTextField.getText(), sqlDate, ((TipoMoneda)getMonedaTerrestrejComboBox1().getSelectedItem()).getId_tipomoneda());
						JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "Transporte Terrestre Modificado con Éxito", "Información", JOptionPane.INFORMATION_MESSAGE);
						CostoUnitariodelTarnasportacionTerrestrejTextField.setText(CostoTerrestrejTextField.getText());
					} catch (NumberFormatException e1) {
						// TODO Auto-generated catch block
						e1.printStackTrace();
						...
						if(((TipoMoneda)getMonedaTerrestrejComboBox1().getSelectedItem()).getDescripcion().equals("USD")){
							try {
								ServicioTerrestre.ModificarTransporteTerrestreMaterial(mp.getId_material(), Float.valueOf(ImporteTerrestrejTextField.getText()), null, 0, 0, Float.valueOf(CantidadTransportadajTextField.getText()), Float.valueOf(CostoTerrestrejTextField.getText()), NombreProveedorTerrestrejTextField.getText(), NumeroFacturaTerrestrejTextField.getText(), sqlDate, ((TipoMoneda)getMonedaTerrestrejComboBox1().getSelectedItem()).getId_tipomoneda());
								JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "Transporte Terrestre Modificado con Éxito", "Información", JOptionPane.INFORMATION_MESSAGE);
								CostoUnitariodelTarnasportacionTerrestrejTextField.setText(CostoTerrestrejTextField.getText());
								TasaCAmbiojTextField.setText("");
								ImportejTextField.setText("");
						...
						JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "Debe Elegir el Tipo de Moneda", "Información", JOptionPane.ERROR_MESSAGE);
					}
					System.out.println("actionPerformed()"); // TODO Auto-generated Event stub actionPerformed()
				}
			});
		...
		if (jButton21 == null) {
			...
			jButton21.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					java.sql.Date sqlDate = new java.sql.Date(getDatespinnerDateModel7().getDate().getTime());
					try {						
						ServicioAduana.ModificarAduanaMaterial(mp.getId_material(),Float.valueOf( ImporteDOPjTextField.getText()), sqlDate, Float.valueOf(TasaCAmbioADuanajTextField.getText()), Float.valueOf(ImporteAduanajTextField.getText()), Float.valueOf(CantidadTransportadajTextField.getText()) ,Float.valueOf(CostoAduanajTextField.getText()));
						JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "Pago en Aduana de la Zona Franca Modificado con Éxito", "Información", JOptionPane.INFORMATION_MESSAGE);
						CostoUnitarioAdunajTextField.setText(CostoAduanajTextField.getText());
					} catch (NumberFormatException e1) {
						// TODO Auto-generated catch block
						e1.printStackTrace();
			...
			jButton22.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					if(((TipoMoneda)getMonedajComboBox1().getSelectedItem()).getDescripcion().equals("USD") && TasaConversionjTextField.getText().length()==0){
						try {
							Reportes.getR().ImprimirTransportaciónAéreaoMarítimaMaterial(mp.getId_material());
					...
					if(((TipoMoneda)getMonedajComboBox1().getSelectedItem()).getDescripcion().equals("EUR") && TasaConversionjTextField.getText().length()!=0){
						try {
							Reportes.getR().ImprimirTransportaciónAéreaoMarítimaEURMaterial(mp.getId_material());
						} catch (JRException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						}	
						...
						JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "Es necesario que elija el Tipo de Moneda", "Informacion", JOptionPane.ERROR_MESSAGE);
					}
					System.out.println("actionPerformed()"); // TODO Auto-generated Event stub actionPerformed()
				}
			});
			...
			jButton23.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if(getMonedaDesjComboBox1().getSelectedIndex()!=0){
						...
						try {
							Reportes.getR().ImprimirDesaduanizacionUSDMaterial(mp.getId_material());
						} catch (JRException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						}
						...
						if(((TipoMoneda)getMonedaDesjComboBox1().getSelectedItem()).getDescripcion().equals("DOP") && TasaCambioDesjTextField1.getText().length()!=0){
							try {
								Reportes.getR().ImprimirDesaduanizacionDOPMaterial(mp.getId_material());
							} catch (JRException e1) {
								// TODO Auto-generated catch block
								e1.printStackTrace();
							}
			...
			ImprimirjButton24.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					if(((TipoMoneda)getMonedaTerrestrejComboBox1().getSelectedItem()).getDescripcion().equals("USD") && TasaCAmbiojTextField.getText().length()==0){
						try {
							Reportes.getR().ImprimirTransportaciónTerrestreUSDMaterial(mp.getId_material());
						} catch (JRException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						}
					...
					if(((TipoMoneda)getMonedaTerrestrejComboBox1().getSelectedItem()).getDescripcion().equals("DOP") && TasaCAmbiojTextField.getText().length()!=0){
						try {
							Reportes.getR().ImprimirTransportaciónTerrestreDOPMaterial(mp.getId_material());
						} catch (JRException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						}
	...
	private JButton getJButton24() {
		if (jButton24 == null) {
			...
			jButton24.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					try {
						Reportes.getR().ImprimirAduanaZonaFrancaMaterial(mp.getId_material());
					} catch (JRException e1) {
						// TODO Auto-generated catch block
						e1.printStackTrace();
					}
	...
	private JTextField getJTextField() {
		if (jTextField == null) {
			...
			jTextField.setBounds(new Rectangle(484, 92, 183, 26));
			DecimalFormatSymbols simbolo=new DecimalFormatSymbols();
		    simbolo.setDecimalSeparator('.');
			DecimalFormat dosDigitos = new DecimalFormat( "####.#####",simbolo);
			if(mp.getPrecioAdquisicionconvertidoEURaUSDconMolde()!=0){
				jTextField.setText(String.valueOf(dosDigitos.format(mp.getPrecioAdquisicionconvertidoEURaUSDconMolde())));
			}else{
				jTextField.setText(String.valueOf(dosDigitos.format(mp.getPrecioAdquisicionUSDconMolde())));
			}
		}
		return jTextField;
	}
	...
	private JButton getJButton25() {
		if (jButton25 == null) {
			...
			jButton25.setBounds(new Rectangle(16, 62, 286, 35));
			...
			jButton25.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					if(mp.getMoneda().equals("USD") && PrecioConvertidoDOPaUSDjTextField.getText().equals("0") && jTextField.getText().equals("0") && LogisticajTextField.getText().length()==0){
					try {
						Reportes.getR().ImprimirMaterialCostoUSDImportado(mp.getId_material());
					} catch (JRException e1) {
						// TODO Auto-generated catch block
						e1.printStackTrace();
					}
					...
					if(mp.getMoneda().equals("USD") && PrecioConvertidoDOPaUSDjTextField.getText().equals("0") && jTextField.getText().equals("0") && LogisticajTextField.getText().length()!=0){
						try {
							Reportes.getR().ImprimirMaterialCostoUSDImportadoconLogistica(mp.getId_material());
						} catch (JRException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						}
					...
					if(mp.getMoneda().equals("USD") && (!PrecioConvertidoDOPaUSDjTextField.getText().equals("0")) && jTextField.getText().equals("0") && LogisticajTextField.getText().length()==0){
						try {
							Reportes.getR().ImprimirMaterialCostoUSDImportadoconGastos(mp.getId_material());
						} catch (JRException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						}
					...
					if(mp.getMoneda().equals("USD") && (!PrecioConvertidoDOPaUSDjTextField.getText().equals("0")) && jTextField.getText().equals("0") && LogisticajTextField.getText().length()!=0){
						try {
							Reportes.getR().ImprimirMaterialCostoUSDImportadoconGastosyLogistica(mp.getId_material());
						} catch (JRException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						}
					...
					if(mp.getMoneda().equals("USD") && PrecioConvertidoDOPaUSDjTextField.getText().equals("0") && (!jTextField.getText().equals("0")) && LogisticajTextField.getText().length()==0){
						try {
							Reportes.getR().ImprimirMaterialCostoUSDImportadoconMolde(mp.getId_material());
						} catch (JRException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						}
					...
					if(mp.getMoneda().equals("USD") && PrecioConvertidoDOPaUSDjTextField.getText().equals("0") && (!jTextField.getText().equals("0")) && LogisticajTextField.getText().length()!=0){
						try {
							Reportes.getR().ImprimirMaterialCostoUSDImportadoconMoldeyLogistica(mp.getId_material());
						} catch (JRException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						}
					...
					if(mp.getMoneda().equals("USD") && (!PrecioConvertidoDOPaUSDjTextField.getText().equals("0")) && (!jTextField.getText().equals("0")) && LogisticajTextField.getText().length()==0){
						try {
							Reportes.getR().ImprimirMaterialCostoUSDImportadoconMoldeyGastos(mp.getId_material());
						} catch (JRException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						}
					...
					if(mp.getMoneda().equals("USD") && (!PrecioConvertidoDOPaUSDjTextField.getText().equals("0")) && (!jTextField.getText().equals("0")) && LogisticajTextField.getText().length()!=0){
						try {
							Reportes.getR().ImprimirMaterialCostoUSDImportadoconGastosyLogisticayMolde(mp.getId_material());
						} catch (JRException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						}
					...
					if(mp.getMoneda().equals("EUR") && PrecioConvertidoDOPaUSDjTextField.getText().equals("0") && jTextField.getText().equals("0") && LogisticajTextField.getText().length()==0){
						try {
							Reportes.getR().ImprimirMaterialCostoEURImportado(mp.getId_material());
						} catch (JRException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						}
					...
					if(mp.getMoneda().equals("EUR") && PrecioConvertidoDOPaUSDjTextField.getText().equals("0") && jTextField.getText().equals("0") && LogisticajTextField.getText().length()!=0){
						try {
							Reportes.getR().ImprimirMaterialCostoEURImportadoconLogistica(mp.getId_material());
						} catch (JRException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						}
					...
					if(mp.getMoneda().equals("EUR") && (!PrecioConvertidoDOPaUSDjTextField.getText().equals("0")) && jTextField.getText().equals("0") && LogisticajTextField.getText().length()==0){
						try {
							Reportes.getR().ImprimirMaterialCostoEURImportadoconGAstos(mp.getId_material());
						} catch (JRException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						}
					...
					if(mp.getMoneda().equals("EUR") && (!PrecioConvertidoDOPaUSDjTextField.getText().equals("0")) && jTextField.getText().equals("0") && LogisticajTextField.getText().length()!=0){
						try {
							Reportes.getR().ImprimirMaterialCostoEURImportadoconGAstosyLogistica(mp.getId_material());
						} catch (JRException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						}
					...
					if(mp.getMoneda().equals("EUR") && PrecioConvertidoDOPaUSDjTextField.getText().equals("0") && (!jTextField.getText().equals("0")) && LogisticajTextField.getText().length()==0){
						try {
							Reportes.getR().ImprimirMaterialCostoEURImportadoconMolde(mp.getId_material());
						} catch (JRException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						}
					...
					if(mp.getMoneda().equals("EUR") && PrecioConvertidoDOPaUSDjTextField.getText().equals("0") && (!jTextField.getText().equals("0")) && LogisticajTextField.getText().length()!=0){
						try {
							Reportes.getR().ImprimirMaterialCostoEURImportadoconMoldeyLogistica(mp.getId_material());
						} catch (JRException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						}
					...
					if(mp.getMoneda().equals("EUR") && (!PrecioConvertidoDOPaUSDjTextField.getText().equals("0")) && (!jTextField.getText().equals("0")) && LogisticajTextField.getText().length()==0){
						try {
							Reportes.getR().ImprimirMaterialCostoEURImportadoconMoldeyGastos(mp.getId_material());
						} catch (JRException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						}
					...
					if(mp.getMoneda().equals("EUR") && (!PrecioConvertidoDOPaUSDjTextField.getText().equals("0")) && (!jTextField.getText().equals("0")) && LogisticajTextField.getText().length()!=0){
						try {
							Reportes.getR().ImprimirMaterialCostoEURImportadoconMoldeyGastosyLogistica(mp.getId_material());
						} catch (JRException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						}
						...
						JOptionPane.showMessageDialog(GestionarMaterialExtranjeroVisual.this, "Antes de Imprimir se deben calcular los Costos de Transportación, Desaduanización y Pago en Aduana de la Zona Franca ", "Información", JOptionPane.ERROR_MESSAGE);
					}
					System.out.println("actionPerformed()"); // TODO Auto-generated Event stub actionPerformed()
				}
			});
	...
	private JPanel getJPanel16() {
		if (jPanel16 == null) {
			...
			jPanel16.add(getJTextField(), null);
			jPanel16.add(jLabel36, null);
